...
export default function ProductDetailsPage({ product }: { product: Product }) {
  ...
  const handleWishlist = () => {
    if (isInWishlist(product.id)) {
      ...
      addToWishlist({ id: product.id, name: product.name, price: product.price, image: product.images[0], category: product.category });
    }
  };
              ...
              <div className="ps-lg-4">
                ...
                <div className="mb-4 d-flex flex-column gap-2">
                  <div className="d-flex gap-2">
                    ...
                    <span className="fw-medium">NewHome</span>
                  </div>
                  <div className="d-flex gap-2">
